...
% 本程序方法为：
% 采用 两两一对 训练方式 
% 训练样本:[Y N] Ps: Y 为正面训练集 N 为负面训练集
% 标签样本:[1 0] Ps: 1 为正面训练标签 0 为负面训练标签
% 两两一组 放入 S V M Matlab 训练器 中训练得到相应模型
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%以下为程序控制部分     你要设置的
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
disp(['S V M 算法 训练 ',num2str(Flower_Num),' 种花的总识别率为: ',num2str(result_Rate*100),' %'])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
